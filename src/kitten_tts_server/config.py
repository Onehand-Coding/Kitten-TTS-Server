...
def get_project_root(start_path=None):
    ...
    Args:
        start_path (str or Path, optional): Starting directory to search from. Defaults to current working directory.
    Returns:
        Path: Path to the project root directory containing pyproject.toml
    Raises:
...
DEFAULT_LOGS_PATH = PROJECT_ROOT / "logs"
DEFAULT_MODEL_FILES_PATH = PROJECT_ROOT / "./model_cache"  # For downloaded model files
DEFAULT_OUTPUT_PATH = PROJECT_ROOT / "./outputs"  # For server-saved audio outputs (if any)
